...
mod tests {
	...
	fn test_index_key_schedule() {
		...
		assert_eq!([0x2b7e1516, 0x28aed2a6, 0xabf71588, 0x09cf4f3c], schedule[0]);
		assert_eq!([0xa0fafe17, 0x88542cb1, 0x23a33939, 0x2a6c7605], schedule[1]);
	}
}